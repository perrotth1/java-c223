...
public class ClassRosterDaoFileImplTest {
    ...
    /**
     * BeforeEach tag makes this code run before every test, so we use it to 
     * blank the test data file and set up a new DAO object, to start fresh
     * @throws Exception 
     */
    @BeforeEach
    public void setUp() throws Exception{
        String testFile = "TEST_ROSTER.txt";
        new FileWriter(testFile);   //quickly blanks the file
